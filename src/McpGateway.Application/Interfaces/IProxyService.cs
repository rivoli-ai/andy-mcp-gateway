...
{
    Task<ProxyResult> ForwardRequestAsync(string adapterName, string endpoint, JsonElement body, bool retry = false);
    Task<ProxyResult> ForwardGetRequestAsync(string adapterName, string endpoint, bool retry = false);
